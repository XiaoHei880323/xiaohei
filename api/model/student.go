...
type Student struct {
	...
	StudentNo  string    `xorm:"not null unique comment('学号') VARCHAR(50)"`
	Name       string    `xorm:"not null comment('姓名') VARCHAR(100)"`
	...
	ClassName  string    `xorm:"not null default '' comment('班级') VARCHAR(100)"`
